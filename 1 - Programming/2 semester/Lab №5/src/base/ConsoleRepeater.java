...
public class ConsoleRepeater implements Repeater {
    ...
    public ConsoleRepeater(CollectionKeeper collectionManager, SetKeeper marineSetter) {
    ...
    public SpaceMarine repeatFields(Integer id) {
        ...
        if (id == null) marineSetter.setFieldId(spaceMarine, collectionManager.nextId());
